...
{
	ns0#search: {
		ns0#searchRecord @("xmlns:ns0": ns0,"xmlns:ns01": ns01, xsi#"type": "ns01:TransactionSearchAdvanced",  savedSearchId: p('customer.refund.savesearch.savedSearchId') , savedSearchScriptId: p('customer.refund.savesearch.savedSearchScriptId')): {
		}
	}
}