    ...
    (payload map ((item, index) -> 
      ns0#record @("xmlns:ns0": ns0, "xmlns:ns01": ns01, xsi#"type": "ns01:CustomerRefund", internalId: item.internalId): {
        ns01#customFieldList: {
          StringCustomFieldRef__custbody_jpm_payment_file_name: {
            ns02#value: item.customFieldList.customField.StringCustomFieldRef__custbody_jpm_payment_file_name
          },
          BooleanCustomFieldRef__custbody_payment_sent_jpm: {
            ns02#value: item.customFieldList.customField.BooleanCustomFieldRef__custbody_payment_sent_jpm
          }
        }
      }
    ))
