...
{
	ns0#search: {
		ns0#searchRecord @("xmlns:ns0": ns0,"xmlns:ns01": ns01, xsi#"type": "ns01:ContactSearchAdvanced"): {
			savedSearchId: p('savesearch.contacts.id'),
			savedSearchScriptId: p('savesearch.contacts.scriptid')
		}
	}
} 