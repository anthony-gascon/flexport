...
{
	ns0#search: {
		ns0#searchRecord @("xmlns:ns0": ns0,"xmlns:ns01": ns01, xsi#"type": "ns01:TransactionSearchAdvanced"): {
			savedSearchId: p('savesearch.invoices.id'),
			savedSearchScriptId: p('savesearch.invoices.scriptid')
		}
	}
}