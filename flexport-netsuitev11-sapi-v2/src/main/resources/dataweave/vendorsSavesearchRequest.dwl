...
{
	ns0#search: {
		ns0#searchRecord @("xmlns:ns0": ns0,"xmlns:ns01": ns01, xsi#"type": "ns01:VendorSearchAdvanced"): {
			savedSearchId: p('savesearch.vendors.id'),
			savedSearchScriptId: p('savesearch.vendors.scriptid')
		}
	}
}